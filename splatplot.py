...
n,t,x,y,z,k = np.genfromtxt( "splats_deepcham.txt", unpack=True, skip_header=87, skip_footer=1, autostrip=True)

cham = 2  #number of chamfers
...
fig.tight_layout()
fig.savefig("splats"+str(cham)+"cham_deep.pdf", bbox_inches = 'tight', pad_inches = 0.1, transparent=True)
fig.savefig("splats"+str(cham)+"cham_deep.png", bbox_inches = 'tight', pad_inches = 0.1, transparent=True)